...
let
  ...
  myPython = with pkgs; python36.withPackages(ps: with ps; (builtins.attrValues pythonMissing.packages) ++ [ python django_2_0 automat markdown pyhamcrest pyjwt pygments twisted amqp asgiref asn1crypto async-timeout attrs audioread autobahn backcall beautifulsoup4 billiard celery certifi cffi chardet constantly cryptography daphne decorator defusedxml future httplib2 hyperlink idna incremental ipython jedi kombu msgpack mutagen oauth2client oauthlib olefile parso pendulum pexpect pickleshare ptyprocess pyacoustid pyasn1 pyasn1-modules pycparser python-dateutil python3-openid pytz pytzdata raven redis requests rsa simplegeneric traitlets txaio uritemplate urllib3 vine wcwidth whitenoise youtube-dl google_api_python_client ipython_genutils prompt_toolkit psycopg2 python_magic requests_oauthlib ldap pillow django_taggit]);
