...
#
# COMMAND:
#   pypi2nix -V 3.6 -r base.txt -E postgresql -E libffi -E openssl -E openldap -E cyrus_sasl -E pkgconfig -E libjpeg -E openjpeg -E zlib -E libtiff -E freetype -E lcms2 -E libwebp -E tcl
#
