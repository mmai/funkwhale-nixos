...
let
  ...
  generated = self: {
    ...
    "autobahn" = python.mkDerivation {
      name = "autobahn-18.11.1";
      src = pkgs.fetchurl { url = "https://files.pythonhosted.org/packages/01/ee/d401d58dc7732fadf4fd12d7fb87dd2f3e5e2d0ba65865495565f97c2c31/autobahn-18.11.1.tar.gz"; sha256 = "c7e775e46fc033160fa89942de4953ca739f26167f74431dc2c8a3cd165b8755"; };
      doCheck = commonDoCheck;
      buildInputs = commonBuildInputs;
      propagatedBuildInputs = [
      self."Twisted"
    ...
    "youtube-dl" = python.mkDerivation {
      name = "youtube-dl-2018.11.7";
      src = pkgs.fetchurl { url = "https://files.pythonhosted.org/packages/6a/e0/68e3701ca58ea54aab4abb018ab9fe76807598d45d46a787a3d3c986ec1c/youtube_dl-2018.11.7.tar.gz"; sha256 = "f9b4a65e544b4a2b958ef693cd4b71ab5a5709ab1c7a9fc47c1a967dcca46f4a"; };
      doCheck = commonDoCheck;
      buildInputs = commonBuildInputs;
      propagatedBuildInputs = [ ];
      meta = with pkgs.stdenv.lib; {
